...
- **[maze](./maze/)** - A canvas-based interactive maze game. ([Live Demo](https://maze-omega-lyart.vercel.app))
- **[Movie](./Movie/)** - A movie information application featuring autocomplete search using public APIs. ([Live Demo](https://movie-seven-coral.vercel.app))
